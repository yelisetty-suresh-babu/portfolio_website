...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  useEffect(() => {
    if (ref.current) {
      ...
      setHeight(rect.height + 2600); // Add 60px buffer to extend the line
    }
  }, [ref]);
    ...
    >
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div id="thing" className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-white dark:bg-black flex items-center justify-center">
        ...
        <div
          ...
          className="absolute left-3 ml-5 -translate-x-1/2 top-0 overflow-hidden w-[2px] z-0 bg-gradient-to-b from-blue-500 via-purple-500 to-transparent"
        >
          <motion.div
            style={{
